...
export function PanelMemo() {
  const [noticeOpen, setNoticeOpen] = useState(true);

  return (
    <div className="bg-white flex flex-col flex-1 min-h-0 overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between px-[10.5px] py-[8px] border-t border-b border-[var(--line-subtle)] flex-shrink-0">
        ...
        <div className="flex items-end gap-[5.25px]">
          ...
          <div className="w-[30px] h-[30px] bg-[var(--bg-primary-subtle)] rounded-[6px] flex items-center justify-center flex-shrink-0">
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
              ...
              <defs>
                <clipPath id="clip_send_memo"><rect fill="white" width="13" height="13"/></clipPath>
              </defs>
            </svg>
          </div>
        </div>
